...
def outlier_detection(error_rates, probs_expert1, probs_expert2, probs_expert3, targets, config, threshold=0.01, phase='val'):
    ...
    with open(f'{save_dir}/expert_selection_uncertainties_stats_threshold_{threshold}.txt', 'w') as f:
    ...
    with open(f'{save_dir}/expert_selection_uncertainties_stats_threshold_{threshold}.txt', 'r') as g:
        for line in g:
            print(line)

    # 保存詳細選取情況到 CSV 文件
    csv_path = f'{save_dir}/expert_selection_uncertainties_stats_threshold_{threshold}.csv'
...
#     ipdb.set_trace()
    ...
    if config.dataset =='mit-states':
        with open('data/mit_state_uncertainties.json', 'w') as fp:
        ...
        with open('data/ut_zappos_uncertainties.json', 'w') as fp:
            json.dump(results, fp, default=handle_special_values)
